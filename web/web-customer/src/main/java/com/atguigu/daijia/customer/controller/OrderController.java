...
public class OrderController {
    ...
    //乘客回到首页后,立即查看订单状态,如果有订单,则显示订单信息并跳转
    ...
    //司乘同显
    //从redis中获取订单的经纬度信息 "update:order:location"=${orderId}
    ...
    //司乘同显
    //计算司机到达乘客下单点的最佳线路,显示在乘客端的地图上
    @Operation(summary = "计算司机到达乘客下单点的最佳线路")
    @GuiguLogin
