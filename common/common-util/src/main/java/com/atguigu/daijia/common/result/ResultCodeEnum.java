...
public enum ResultCodeEnum {
    ...
    LIVE_FACE_FAIL( 218, "人脸识别失败"),
    FILE_ERROR( 219, "文件上传失败"),
    WX_CREATE_ERROR( 220, "微信创建订单失败"),
    ...
    COUPON_USE_FAIL( 251, "优惠券使用失败"),//自定义

    XXL_JOB_ERROR(255, "XXL-JOB调用失败"),

    LOCK_UNLOCK_ERROR( 260, "分布式锁解锁异常"),//自定义
